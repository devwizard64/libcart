...
#define CI_EXT_BASE_REG         0x1F800000

#define CI_BUFFER_REG           (__ci_base_reg+0x0000)
#define CI_SDRAM_ADDR_REG       (__ci_base_reg+0x0004)

#define CI_STATUS_REG           (__ci_base_reg+0x0200)
#define CI_COMMAND_REG          (__ci_base_reg+0x0208)
#define CI_LBA_REG              (__ci_base_reg+0x0210)
#define CI_LENGTH_REG           (__ci_base_reg+0x0218)
#define CI_RESULT_REG           (__ci_base_reg+0x0220)

#define CI_MAGIC_REG            (__ci_base_reg+0x02EC)
#define CI_VARIANT_REG          (__ci_base_reg+0x02F0)
#define CI_REVISION_REG         (__ci_base_reg+0x02FC)
